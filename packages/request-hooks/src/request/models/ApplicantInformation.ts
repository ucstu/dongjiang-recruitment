...
export type ApplicantInformation = {
   ...
   */
  workingYears: ApplicantInformation.workingYears;
  /**
   * {0:未知,1:大专,2:本科,3:硕士,4:博士}
   */
  education: ApplicantInformation.education;
  /**
   * 个人优势
   */
   ...
   */
  jobStatus: ApplicantInformation.jobStatus;
  /**
   * 图片作品
   */
   ...
   * {1:实名,2:匿名}
   */
  privacySettings: ApplicantInformation.privacySettings;
};

export namespace ApplicantInformation {
  /**
   * {1:没有工作经验,2:在校/应届,3:3年一下,4:3-5年,5:5-10年,6:10年以上}
   */
