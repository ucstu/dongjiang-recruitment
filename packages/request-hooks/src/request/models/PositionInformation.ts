...
export type PositionInformation = {
   ...
   */
  workingYears: PositionInformation.workingYears;
  /**
   * {1:不要求,2:大专,3:本科,4:硕士,5:博士}
   */
  education: PositionInformation.education;
  /**
   * 细分标签
   */
   ...
   * {1:全职,2:兼职,3:实习}
   */
  workType: PositionInformation.workType;
  /**
   * 所属部门
   */
   ...
   * {1:周末双休:,2:周末单休,3:大小周}
   */
  weekendReleaseTime: PositionInformation.weekendReleaseTime;
  /**
   * 上班时间
   */
  workTime: string;
  ...
  interviewInfo: {
     ...
     */
    situation: PositionInformation.situation;
    /**
     * {1:1-2轮次,2:3-4轮次,3:5-6轮次,4:暂不确定}
     */
    wheel: PositionInformation.wheel;
    /**
     * {1:一天内完成,2:分多次完成}
     */
    time: PositionInformation.time;
    /**
     * {1:可周末面试,2:包含笔试,3:可下班面试,4:包含面试作业}
     */
    illustrate: PositionInformation.illustrate;
  };
  /**
   * 上班地点
   */
...
export namespace PositionInformation {
  /**
   * {1:经验不限,2:在校/应届,3:3年及以下,4:3-5年,5:5-10年,6:10年以上}
   */
