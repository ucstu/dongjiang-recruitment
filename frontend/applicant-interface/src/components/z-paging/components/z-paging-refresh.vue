  ...
  <view style="height: 100%">
    ...
    >
      <view class="zp-r-left">
        ...
        <image
          v-else
          class="zp-line-loading-image zp-r-left-image"
          :style="[leftImageStyle, imgStyle]"
          :src="leftImageSrc"
        />
        <!-- #endif -->
        ...
        <view
          v-else
          :style="[{ 'margin-right': showUpdateTime ? '18rpx' : '12rpx' }]"
        >
          <loading-indicator
      ...
      <view class="zp-r-right">
        ...
        <text
          ...
          class="zp-r-right-text zp-r-right-time-text"
          :style="[rightTextStyle, updateTimeStyle]"
        >
          {{ refresherTimeText }}
        </text>
      </view>
...
export default {
  ...
  computed: {
    ...
    leftImageClass() {
      ...
      return `zp-r-left-image zp-r-left-image-pre-size ${
